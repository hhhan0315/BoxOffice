...
final class TmdbRepository {
    ...
    func getMovieTmdbResponse(movieName: String, openYear: String) -> Observable<MovieTmdbResponseDTO> {
        let request = MovieTmdbRequestDTO(apiKey: self.key, query: movieName, year: openYear)
