...
extension DefaultMoviesRepository: MoviesRepository {
    ...
    func fetchWeeklyMovieList(with weekType: WeekType) async throws -> [Movie] {
        ...
        let weeklyMoviesResponseDTO = try await networkService.request(api: KobisAPI.getWeeklyBoxOfficeList(date: oneWeekAgo, weekType: weekType), dataType: WeeklyMoviesResponseDTO.self)
